...
**1. Run with docker**
  ...
  - After a while, the terminal should be something like this:
    - ![run_with_docker](run_with_docker.png)
 ...
 **1. Successfull call**
  ...
  - In the list of dictionaries, dictionaries (10 in total), are sorted in alphabetical order, and each dictionary contains a key, value pair for artist/author, title ,type item found (book#volume or song).
