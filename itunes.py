...
class Itunes(object):
    ...
    def song_search(self,term):
        ...
        results, song_result_status,song_time_lapse = self.initiate_calls.init_request(self.song_base_url
                                                                                      ,self.song_payload)
        ...
        if len(results) > 0:
            ...
            for each_item in results:
                each_item_kind = each_item["kind"] if "kind" in each_item else each_item["wrapperType"]
