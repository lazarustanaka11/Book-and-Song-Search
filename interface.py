...
def check_health():
    ...
    r = {"Itunes_response_time": ping("itunes.apple.com/search?term=jack+johnson&limit=5"),
           "Google_response_time": ping("www.googleapis.com/books/v1/volumes?filter=full&maxResults=5&printType=BOOKS&q=Flowers")}
